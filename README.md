...
OTHER OPTIONS:
    ...
    -s/--strain_ref     Name of the strain to be used as reference (example: 1_Wt)
...
```bash
conda activate digraph
Di-GRAPH.sh -b $CONDA_PREFIX/files/BLAST/ -c $CONDA_PREFIX/files/Categories -g $CONDA_PREFIX/files/RG -i working_directory/ -r $CONDA_PREFIX/files/Report_files/ -S $CONDA_PREFIX/files/Scripts_files/
```
...
<img width="1026" height="897" alt="Di-GRAPH" src="https://github.com/acb-lab/Di_GRAPH/blob/ffdce981c826507b6fc1c379ab7116ee0bdcdb1b/images/Di-GRAPH_visual_summary.png" />
