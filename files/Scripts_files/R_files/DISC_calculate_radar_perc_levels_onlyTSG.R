...
rownames(complete_valid_counts_summary_df_radar) <- c("TSG")
...
rownames(complete_valid_counts_summary_df_radar_50) <- c("TSG")
...
radarchartcirc(df_radar_50, axistype = 1,
               ...
               caxislabels = c(0, 16.6, 33.3, 50, 100)
)
dev.off()