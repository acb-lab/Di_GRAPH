#### R script to calculate % of discordant reads in each Category_A and plot bar plot with SD (blast levels of validation)
...
if (length(args) != 3) {
  ...
  log_step("Usage: script.R <root_dir> <strain> <blast_option>")
