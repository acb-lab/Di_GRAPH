...
LASTMODIF="2026-04-07"
VERSION="0.3.4"
MODIFICATIONS="dust - no in BLAST cross-validation, validation using full chromosome sequence, discordant reads validation in a 10kb region"
...
#MYBLAST=/home/ibfg/GWSL/BLAST # Replace with the path to your MYBLAST directory: path/to/BLAST/features_extraction
